...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Luiz Gustavo", "luizg@gmail.com", new DateTime(1977, 4, 21), 1000.0, d3);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex.g@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d1);
            Seller s6 = new Seller(6, "Alex Pink", "alex.p@gmail.com", new DateTime(1997, 3, 4), 3000.0, d1);
            /*
